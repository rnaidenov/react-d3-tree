    ...
    createClass(SvgTextElement, [{
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            'text',
            _extends({ className: 'nodeNameBase' }, name),
            nameData
          ),
          React.createElement(
            'text',
            { className: 'nodeAttributesBase' },
            attributesData && Object.keys(attributesData).map(function (labelKey) {
              return React.createElement(
                'tspan',
                _extends({}, attributes, { key: uuid.v4() }),
                labelKey,
                ': ',
                attributesData[labelKey]
              );
            })
          )
        );
  ...
  var Node = function (_React$Component) {
    ...
    function Node() {
      ...
      return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Node.__proto__ || Object.getPrototypeOf(Node)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        return allowForeignObjects && nodeLabelComponent ? React.createElement(ForeignObjectElement, _extends({ nodeData: nodeData, nodeSize: nodeSize }, nodeLabelComponent)) :
        React.createElement(SvgTextElement, _extends({ nameData: nodeData.name, attributesData: nodeData.attributes }, nodeLabelProps));
